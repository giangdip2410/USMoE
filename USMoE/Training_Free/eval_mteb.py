    ...
    with torch.no_grad():
        ...
        for (task_name, task_type) in tasks:
            ...
            results = evaluation.run(
                ...
                output_folder=f"mteb_results_ablation_test1/{task_type}/{args.base_model}_{args.use_4bit}_{task_name}_{args.do_pca}_{args.pca_dim}_{args.emb_info}_{args.embed_method}_{args.no_instruction}_{args.similarity_ensemble}_{args.similarity_weights}_{args.ablation}", 
